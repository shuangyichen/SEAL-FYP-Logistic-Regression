...
int main()
{
    ...
    */
    ...
    Ciphertext new_weights = train_cipher(features1_ct, features1_ct, labels_ct, weights_ct, LEARNING_RATE, ITERS, observations, num_weights, evaluator, ckks_encoder, scale, gal_keys, relin_keys, encryptor, decryptor, params);
